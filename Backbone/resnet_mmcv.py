...
if __name__ == '__main__':
    ...
    # print('feat_fpn_flatten_list:', feat_fpn_flatten_list.size())
    print('feat_fpn:', len(feat_fpn_flatten_list), feat_fpn_flatten_list[0].size(), feat_fpn_flatten_list[1].size(), feat_fpn_flatten_list[2].size(), feat_fpn_flatten_list[3].size())
